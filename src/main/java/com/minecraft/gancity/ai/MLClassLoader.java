...
/**
 * Lazy-loading wrapper for ML classes to prevent classloading crash during early mod bootstrap.
 *
 * Problem: Importing ml.* at top of MobBehaviorAI can trigger DJL classloading too early,
 * which can crash before gameplay starts if DJL native libs fail to load during bootstrap.
 *
...
public class MLClassLoader {
     ...
     * Initialize all ML systems via reflection.
        * Called AFTER mod initialization completes (during server start).
     */
